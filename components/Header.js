...
const callsToAction = [
    { name: 'Logout', href: '/auth?option=login', icon: PlayIcon },
]
const resources = [
    {
        name: 'Help Center',
                                    ...
                                    <div className={"mx-2 hidden md:block "}>
                                        <div className="xl:w-96">
                                            <div className="input-group flex  items-stretch w-full">
                                                <input type="search" onChange={onKeyPressChange} value={searchQuery?searchQuery.query:""}
                            ...
                            {user?    <Popover className="relative">
                                    {({ open }) => (
                                        <>
                                            ...
                                            >
                                                <Popover.Panel className="absolute z-10 mt-5 transform md:left-0.5 lg:left-0.2 lg:ml-0 lg:-translate-x-1/2 ">
                                                    <div className="overflow-hidden w-full rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 ">
                                                        <div className="relative bg-neutral-800 px-5 py-6">
                                                            {solutions.map((item) => (
                                                                <a
                                                                    key={item.name}
                                                                    href={item.href}
                                                        ...
                                                        <div className="space-y-6 bg-neutral-900 px-5 py-5 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8">
                                                            {callsToAction.map((item) => (
                                                                <div key={item.name} className="flow-root">
                                                                    <a
                                                                        href={item.href} onClick={()=>{signOut({callbackUrl:'/'})}}
