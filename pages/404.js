                ...
                <section className="bg-white dark:bg-neutral-900 min-h-screen">
                    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 h-screen">
                        <div className="mx-auto max-w-screen-sm text-center self-center">
                            ...
                            <p className="mb-4 text-3xl tracking-tight font-bold text-gray-900 md:text-4xl dark:text-white">Somethings
                                missing.</p>
                            <p className="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Sorry, we cant find
                                that page. Youll find lots to explore on the home page. </p>
                            <a href="#"
